...
#                            Initialization
# =============================================================================
    # Traces of the ZHAireS simulated shower: "True Monte-Carlo shower or reference shower"
...
# =============================================================================
    ...
    for i in range(NantTargetLayout):
        ...
        # If there is no solution we fill the outputs with nan
        except(IndexError):
            Load = False
